...
export const TABLE_COUNT_REQUEST = 'TABLE_COUNT_REQUEST'
export const TABLE_COUNT_SUCCESS = 'TABLE_COUNT_SUCCESS'
export const TABLE_COUNT_FAIL = 'TABLE_COUNT_FAIL'
export const TABLE_COUNT_RESET = 'TABLE_COUNT_RESET'
